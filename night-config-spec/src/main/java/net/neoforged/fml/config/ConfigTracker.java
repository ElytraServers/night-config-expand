...
public class ConfigTracker {
    ...
    private static final Path defaultConfigPath = Path.of("config");
    ...
    static void loadConfig(ModConfig modConfig, Path path) {
        ...
        modConfig.setConfig(new LoadedConfig(config, path, modConfig));
    }
    ...
    public static void acceptSyncedConfig(ModConfig modConfig, byte[] bytes) {
        ...
        modConfig.setConfig(new LoadedConfig(newConfig, null, modConfig)); // TODO: should maybe be Loading on the first load?
    }
    ...
    public void loadDefaultServerConfigs() {
        configSets.get(ModConfig.Type.SERVER).forEach(modConfig -> {
            ...
            modConfig.setConfig(new LoadedConfig(createDefaultConfig(modConfig.getSpec()), null, modConfig));
        });
    }
