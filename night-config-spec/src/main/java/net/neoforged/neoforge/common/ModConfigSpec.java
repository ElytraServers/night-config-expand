...
public class ModConfigSpec implements IConfigSpec {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ModConfigSpec.class);
    ...
    public boolean isCorrect(UnmodifiableCommentedConfig config) {
        ...
        return correct(this.spec, config, parentPath, Collections.unmodifiableList(parentPath), (a, b, c, d) -> {
        }, null, true) == 0;
    }
